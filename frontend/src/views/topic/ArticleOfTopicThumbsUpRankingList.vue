...
const refreshRankingList = async () => {
  const data = await queryArticleListOfTopic(topicId, 0, 10, 6);
  if (data !== null) {
...
<template>
  <el-container>
    <el-header style="height: 30px;">
      <div style="margin: 5px auto; height: 20px; display: flex; align-items: center; justify-content: center;">
        <el-icon style="color: red; margin-right: 5px">
          <Histogram/>
        </el-icon>
        <span style="color: darkred; font-weight: bold">好评榜</span>
