  ...
  <el-container>
    <el-header class="header" style="margin: 0 25px; height: 100%">
      <el-row :gutter="20" style="margin-top: 40px; margin-bottom: 20px" align="middle" justify="center">
        <el-col :span="2">
          <el-avatar style="background-color: transparent; float: right; cursor: pointer" :size="75" :src="store.getters.getAvatar"
                     @click="router.push('/userCenter/account/information')"/>
        </el-col>
        <el-col :span="11">
          <el-row align="middle">
            <el-text style="color: black; font-weight: bolder; font-size: 22px; cursor: pointer"
                     @click="router.push('/userCenter/account/information')">
          ...
          <el-row align="middle" justify="center" @click="router.push('/userCenter/account/level')"
                  style="margin-top: 16px; text-align: center; width: 50%; font-size: 12px; margin-left: -8px; cursor: pointer">
